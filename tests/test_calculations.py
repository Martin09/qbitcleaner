...
class TestSeedingTimeCalculation:
    ...
    def test_calculate_seeding_time_with_completion_on(self, config_file, mock_torrent, timestamp_20_days_ago):
    ...
    def test_calculate_seeding_time_with_added_on_fallback(self, config_file, mock_torrent, timestamp_20_days_ago):
...
class TestUploadedGBCalculation:
    ...
    def test_get_uploaded_gb(self, config_file, mock_torrent):
    ...
    def test_get_uploaded_gb_zero(self, config_file, mock_torrent):
    ...
    def test_get_uploaded_gb_small(self, config_file, mock_torrent):
...
class TestPopularityCalculation:
    ...
    def test_get_popularity(self, config_file, mock_torrent):
    ...
    def test_get_popularity_none(self, config_file, mock_torrent):
    ...
    def test_get_popularity_missing_attribute(self, config_file, mock_torrent):
